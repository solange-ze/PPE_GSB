...
class PdoGsb
{
    ...
    public function getInfosPatron($login, $mdp)//cette fonction verifie si le login et le mdp se trouvent ds la bdd et kel est le nom et le prenom de cet utilisateur.
    {
        $requetePrepare = PdoGsb::$monPdo->prepare(
        ...
        public function voirComptables()//cette fonction verifie si le login et le mdp se trouvent ds la bdd et kel est le nom et le prenom de cet utilisateur.
    {
        $requetePrepare = PdoGsb::$monPdo->prepare(
            'SELECT comptable.id AS id, comptable.nom AS nom, comptable.prenom AS prenom '
            . 'comptable.datederniereconnexion AS derniereConnexion '
            . 'FROM comptable '
   ...
   /**
    ...
    public function getnbdefichesvalide()
    {
         $requetePrepare = PdoGSB::$monPdo->prepare(
            'SELECT COUNT(idvisiteur) FROM fichefrais '
            . 'WHERE fichefrais.idetat="VA"' 
                . 'AND mois = :unMois' 
    ...
    public function getpourcentagevalid()
    { 
        return getnbdefichevalide()+1*1/100;
    }
